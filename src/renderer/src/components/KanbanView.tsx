...
import { Plus, Layers, LayoutGrid, KanbanSquare, Eye } from 'lucide-react'
...
import BoardThemeMenu from './kanban/BoardThemeMenu'
import { useBoardTheme } from './kanban/useBoardTheme'
