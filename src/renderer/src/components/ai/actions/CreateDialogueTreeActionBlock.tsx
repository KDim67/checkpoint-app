...
export default function CreateDialogueTreeActionBlock({ jsonString }: { jsonString: string }) {
  ...
  // parsed stays raw, it goes verbatim to the Dialogue Builder and the export
    ...
    <div style={{
      ...
      <div style={{ display: 'flex', gap: '6px', flexWrap: 'wrap', borderTop: '1px solid rgba(168,85,247,0.15)', paddingTop: '10px', justifyContent: 'flex-end' }}>
        <button
          ...
          className="create-dialogue-tree-action-block-icon-btn"
          style={iconBtn}
        >
        ...
        <button
          ...
          className="create-dialogue-tree-action-block-load"
          data-loaded={loaded || undefined}
          style={{
            border: 'none',
            // plain surface once loaded, the white veil vanished in light mode
